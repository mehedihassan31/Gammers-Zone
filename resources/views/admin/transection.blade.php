      ...
      <div class="modal-content">
                      ...
                      <div class="modal-body  text-center">
                                <div  id="courseEditFrom" class="container none">
                                    ...
                                    <Label>User Id:</Label><h5 type="hidden" id="updateCourseUserid"> </h5>
                                    <label>Price:</label> <h5  id="tAmmount"> </h5>
                                      <div class="row">
...
axios.get('/admin/getTransectionData')
.then(function (response){
  if(response.status==200)
  {
    ...
    "<td> <a class='serviceeditbtn' data-price='"+jsonData[i].ammount+"' data-user='"+jsonData[i].user.id+"' data-id='"+jsonData[i].id+"' ><i class='fas fa-edit'> Confirmation </i></a></td>"+
...
function tranDelete(deleteid){
  ...
  axios.post('/admin/TransectionDelete',{id:deleteid})
  .then(function(response){
...
$('#statusId').click(function(){
  ...
  var  userid=$('#updateCourseUserid').html();
  var  ammount=$('#tAmmount').html();
  var  status=$('#statusId').text();
   statusUpdate(id,userid,ammount,status);
})

function statusUpdate(id,userid,ammount,status){



    axios.post('/admin/StatusConfirm',{
                    id:id,
                    userid:userid,
                    ammount:ammount,
                    status:status
